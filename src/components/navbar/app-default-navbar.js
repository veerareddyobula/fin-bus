...
const AppDefaultNavbar = ({toggleSidebar}) => {
        ...
        <nav className="navbar navbar-expand-lg main-navbar">
          <form className="form-inline mr-auto">
            <ul className="navbar-nav mr-3">
              <li>
                <a href="#/" data-toggle="sidebar" className="nav-link nav-link-lg" onClick={(event)=>toggleSidebar(event)}>
          ...
          <ul className="navbar-nav navbar-right">
            <li className="dropdown dropdown-list-toggle">
              ...
              <div className="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div className="dropdown-footer text-center">
                  <a href="#/">
                    View All <FontAwesomeIcon icon={["fas", "chevron-right"]} />
                  </a>
                </div>
              </div>
            </li>
            ...
            <li className="dropdown">
              ...
              >
                ...
                />
                <div className="d-sm-none d-lg-inline-block">Hi, Veera Reddy</div>
              </a>
              <div className="dropdown-menu dropdown-menu-right">
                ...
                >
                  <FontAwesomeIcon icon={["fas", "bolt"]} /> Activities
                </a>
...
export default AppDefaultNavbar;
