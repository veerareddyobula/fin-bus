...
const AppDefaultContainer = (props) => {
  ...
  const toggleLayout = () => {
    ...
    if (w.outerWidth() <= 1024) {
      ...
      if (nowLayoutClass) $("body").addClass(nowLayoutClass);

      let nav_second_classes = $(".main-sidebar").attr("data-nav-classes"),
        nav_second = $(".main-sidebar");

      if (
        nowLayoutClass === "layout-3" &&
      ...
      <div className="main-wrapper">
        ...
        <footer class="main-footer">
          <div class="footer-left">
            Copyright &copy; 2019 <div class="bullet"></div> Design By{" "}
            <a href="https://veerareddyobula.github.io/profile/#/">
              Veera Reddy.Obulareddy
            </a>
          </div>
